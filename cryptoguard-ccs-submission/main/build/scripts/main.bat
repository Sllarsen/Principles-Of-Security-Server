...
set CLASSPATH=%APP_HOME%\lib\main.jar;%APP_HOME%\lib\soot-trunk.jar;%APP_HOME%\lib\axml-2.0.jar;%APP_HOME%\lib\AXMLPrinter2.jar;%APP_HOME%\lib\groovy-2.5.2.jar

@rem Execute main
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MAIN_OPTS%  -classpath "%CLASSPATH%" main.rule.engine.RuleEngine %CMD_LINE_ARGS%
